...
import { ProductService, OrderItemService, IProductSell, INewOrderItem } from '../../../services';
...
export class OrderItemComponent extends BaseComponent implements OnInit {

    header: PageHeader = new PageHeader("Order", ["Retailing", "Order"]);
    orderId: string;
    data: IProductSell[] = [];
    ...
    constructor(private product: ProductService, private orderItem: OrderItemService, private dataTable: TdDataTableService,
